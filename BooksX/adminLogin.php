...
<head>
    ...
    <title>Books|X| AdminLogin</title>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/logninadmin.jpg" alt="sing up image"></figure>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Log in</h2>
                        <h1 class="form-title" style="font-size: 27px; color:rgb(87, 118, 148); margin-top:-35px;">Admin</h1>
