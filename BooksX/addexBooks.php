	...
	if($imgError === 0){
        if($imgSize < 50000000000000000){
            ...
            if(in_array($imgExtLoc,$allowdExts)){
                ...
                $sql="INSERT INTO exchangebooks (bookName,authorName,bookCategory,date,bookDescreption,Demo,img) VALUES ('$bookName','$authorName','$bookCategory','$date','$bookDescreption','$Demo','$imgfile')";
			...
			<button on="tap:sidebar.close" class="close-sidebar">
				...
				<ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
					...
					<li class="nav-item dropdown open">
						<a class="nav-link mbr-semibold link text-black dropdown-toggle display-7" data-toggle="dropdown-submenu" aria-expanded="true">Services</a><div class="dropdown-menu"><a class="mbr-semibold text-black dropdown-item display-7" href="https://mobirise.com/extensions/depotamp/bookstore.html" aria-expanded="false">buy/Sell</a><a class="mbr-semibold text-black dropdown-item display-7" href="https://mobirise.com/extensions/depotamp/fabricstore.html" aria-expanded="false">Exchange</a></div>
					</li>
    ...
    <div class="container">
        ...
        <div class="mbr-row">
            ...
            <div class="mbr-col-lg-8 mbr-m-auto mbr-form" data-form-type="formoid">
                <form method="POST" class="mbr-form i-amphtml-form" data-form-title="Form Name" enctype="multipart/form-data"><input type="hidden" name="email" data-form-email="true" value="vMVKg8fYW5euf9d69c082X1604kEHTllMY0P//+jnDdo9FVm0JqfXEkkJ1L2U2+K5tGkjFFv16hIbksQTdtYBYMfjbQxKTOF3UlzYCQ8o7AW3qn/lNC+lZgXtJ2l7DBr">
                    ...
                    <div class="dragArea formmm">
                        <div class="abcl mbr-col mbr- mbr- mbr- field">
                            ...
                            padding-left: 10px;">Upload the book:</label>
                ...
                <div><button id="cancelbtn" type="submit" class="btn btn-primary display-7" onclick="document.location='exchange.php'">Cancel</button></div>
                <br><br>
            </div>
