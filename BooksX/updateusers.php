...
//retrieve
$sqlretrieve="SELECT * FROM userregisteration where id='$useridfromupdatepage' ";
...
if($result -> num_rows > 0){
    ...
    <table>
    <caption>Current user's data</caption>
    <tr>
        <th>ID</th>
        <th>Username</th>
        <th>Email</th>
    ...
    <input type='text' name='iidd' id='' placeholder='".$row["id"]."' value='".$row["id"]."' required/> <br>
</div>
<div class='form-group'>
    <label for='name'>Username:</label>
    <input type='text' name='name' id='name' placeholder='".$row["userName"]."' value='".$row["userName"]."' required/> <br>
</div>
<div class='form-group'>
    <label for='email'>Email:</label>
    <input type='email' name='email' id='email' placeholder='".$row["email"]."' value='".$row["email"]."' required/><br>
</div>
<div class='form-group'>
    <label for='pass'>Password:</label>
    <input type='password' name='pass' id='pass' placeholder='".$row["password"]."' value='".$row["password"]."' minlength='8' maxlength='16' required/><br>
</div>
<div class='form-group'>
    <label for='re-pass'>Country:</label>
...
$sqlupdate="UPDATE userregisteration SET id='$useriidd', userName='$userrname', email='$email' , password='$passwordd' , country='$country', gender='$gender' WHERE id='$useridfromupdatepage' ";
...
<body>
    ...
    <div class="main">
        ...
        <section class="signup" style="margin:-40px 0px 0px 0px;">
            <div class="container">
                 <h2 class="form-title"  style="font-size: 33px; text-decoration:underline;">Update a user:</h2><br><br>
                 
                 <?php echo $table;?><br><br><br>
                 
<!--foooooooooooooooooooooooooooooooooooooorrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm-->
<?php echo $form;?><br><br><br>
