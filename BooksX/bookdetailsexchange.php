...
//retrieve
$sqlretrieve="SELECT * FROM exchangebooks where id='$iidd' ";
...
if($result -> num_rows > 0){
    ...
    while ($row = $result -> fetch_assoc()) {
        ...
        <div class='col-lg-7 col-md-7 col-sm-6'>
            ...
            <div class='download'><span id='cond'><a href='".$row["Demo"]."' download='".$row["bookName"]."'>Download the Book </a><i class='fa-solid fa-download'> </i></span></div>

            <button onclick='document.location='buy&sell.php' id='back'><a id='aback' href='exchange.php'>Back</a></button>
            </div>
