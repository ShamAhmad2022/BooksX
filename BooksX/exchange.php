                ...
                <div class='col mb-5 data' id='".$row["bookCategory"]."'>
                    <div class='card h-100'>
                        ...
                        <div class='card-footer p-4 pt-0 border-top-0 bg-transparent'>
                            <form action='bookdetailsexchange.php' method='post' style='text-align: center;'>
                                <input type='text' name='iidd' value='".$row["id"]."' style='display: none;'>
                                <input type='submit' value='More details' class='btn btn-outline-dark mt-auto' class='text-center'>
                            </form>
                        </div>
                    </div>
                </div>
...
<html lang="en">
    <head>
        ...
        <title>Books|X| Exchange page</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <header class="bg-dark py-5 backg" style="background-image:url('images/books3-1.jpg'); background-repeat: no-repeat; background-size: cover;">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <h4 style="font-size: 30px;" class="display-4 fw-bolder">Exchange Books</h4>
                    <br>
                    <p class="lead fw-normal text-white-50 mb-0" style="color:white;">Here you can exchange one book with another, you can also read any book you want online.</p>
                </div>
            </div>
        </header>
        ...
        <section class="PBS">
            <div class="publishbooks">
                ...
                <br>
                <button onclick="document.location='addexBooks.php'">Publish Book</button>
            </div>
        </section>
        <br>
        <hr width="90%">
