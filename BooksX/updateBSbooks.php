...
//retrieve
$sqlretrieve="SELECT * FROM sellbuybooks where id='$useridfromupdatepage' ";
...
if($result -> num_rows > 0){
    ...
    $table="
    <table>
    <caption>Buy & sells books</caption>
    <tr>
        <th>ID</th>
        <th>bookName</th>
        <th>authorName</th>
    ...
    while ($row = $result -> fetch_assoc()) {
        ...
        <input type='text' name='booksname' value='".$row["bookName"]."' class='field-input display-7' required='required' id=''><br><br>
            ...
            <input type='number' name='booksprice' value='".$row["price"]."' class='field-input display-7' required='required' id='addbookname'><br><br>
...
$sqlupdate="UPDATE sellbuybooks SET id='$bookID', bookName='$bookName', authorName='$authorName', bookCategory='$bookCategory', date='$date', price='$price' , bookDescreption='$bookDescreption' , Demo='$Demo', img='$imgfile' WHERE id='$useridfromupdatepage' ";
...
<body>
    <body>
        ...
        <section class="content-section tour-section">
            <h2  id="tickets" class="section-head section-head-tour">Manage Buy&sale books</h2>
